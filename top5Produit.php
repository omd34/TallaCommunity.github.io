       ...
       <p> <a href="bienvenu.php">Accueil</a> | <a href="top5produit.php">Produits</a> | <a href="top3service.php">Services</a> |  <a href="top7Photo.php">Photos</a> | </p>     	
			...
			<section class="presentation first">
				<div class="product-presentation">
					<h1>PRODUITS DE LA MENUISERIE Talla Community</h1>
					<p>
					</p>
					 <button onclick="window.location.href = 'connexion.php';">Commander</button>
		...
		<section class="presentation second">
			<div class="product-presentation">
				...
				<h1>La menuiserie Talla Community a une variete de produits tels que :</h1>
				<p>
		   <ul>
        <li>Portes</li>
        <li>Fenêtres</li>
		...
		<li>ETC...</li>
			...
			<button onclick="window.location.href = 'top7Photo.php';">Voir les spécifications</button>
			</div>
			<div class="image-presentation">
				<img
					src="vente/a1.jpg"
